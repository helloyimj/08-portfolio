...
function upData(obj) {
	...
	$td.eq(2).addClass("up_el").html('<input type="number" class="kor form-control" value="'+$td.eq(2).html().replace("점","")+'">');
	$td.eq(3).addClass("up_el").html('<input type="number" class="eng form-control" value="'+$td.eq(3).html().replace("점","")+'">');
	$td.eq(4).addClass("up_el").html('<input type="number" class="math form-control" value="'+$td.eq(4).html().replace("점","")+'">');
	$td.eq(5).html('');
	//console.log(n);
